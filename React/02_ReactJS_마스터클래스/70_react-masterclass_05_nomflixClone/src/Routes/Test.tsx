...
function Test() {
    ...
    const handleDetailInfo = (movieId?:number) => {
    ...
    return (
                                    ...
                                    <Main_Info_Layer>
                                        <Main_Info_Container>
                                            ...
                                            <Main_Button_Container>
                                                ...
                                                {/* 상세 정보 */}
                                                <Detail_Button_Wrapper onClick={() => handleDetailInfo(data?.results[0].id)}>
        ...
        {/* Popup */}
        {
            isOpenMainDetail && 
            <>
                <Detail isOpen={isOpenMainDetail} movieId={data?.results[0].id} />
            </>
        }
        </Body_Container>
